// Se define la clase CZooAnimal y se crea el vector zooAnimals que contiene los objetos de la clase CZooAnimals.
class CZooAnimal {
    constructor() {
// El vector almacena todas las instancias de animales que se crearon.
        this.zooAnimals = [];
    }
// Se define el constructor que inicializa las propiedades de cada instancia.
    agregarAnimal(n, cage, type, weight) {
// IdAnimal se genera de forma aleatoria usando math.random.
...
// Se crean las tablas por donde se mostraran los datos y tambien las funciones para contar y listar animales.
...
// Se crean las cinco instancia de la clase CZooAnimal
...
// Se Genera la tabla de animales
zoo.generarTablaAnimales();

// Se Mustra la cantidad de animales en la jaula 5 cuyo peso sea menor a 3 kg
...
// Se Muestra la cantidad de animales de tipo felinos entre las jaulas 2 y 5
...
// Se Muestra el nombre del animal en la jaula 4 con peso menor a 120
